...
export const mainnetTokens = {
  wht: new Token(MAINNET, '0x5545153CCFcA01fbd7Dd11C0b23ba694D9509A6F', 18, 'WHT', 'Wrapped HT', ''),
  usdt: new Token(MAINNET, '0xa71EdC38d189767582C38A3145b5873052c3e47a', 18, 'Tether USD', 'USDT', ''),
  husd: new Token(MAINNET, '0x0298c2b32eaE4da002a15f36fdf7615BEa3DA047', 8, 'HUSD', 'HUSD', ''),
  wbnb: new Token(
    MAINNET,
